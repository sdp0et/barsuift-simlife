 ...
 * <p>
 * When the speed is increased, the tasks are executed more frequently.
 * </p>
 * 
 */
public interface SynchronizerSlow extends TaskSynchronizer<ConditionalTask>, Persistent<SynchronizerSlowState> {
