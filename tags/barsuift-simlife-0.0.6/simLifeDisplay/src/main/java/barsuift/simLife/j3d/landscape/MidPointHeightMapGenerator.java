...
public class MidPointHeightMapGenerator {
     ...
     */
    public MidPointHeightMapGenerator(LandscapeParameters landscapeParameters) {
        logger.info("Creating a map generator with landscape parameters " + landscapeParameters);
        this.size = landscapeParameters.getSize();
